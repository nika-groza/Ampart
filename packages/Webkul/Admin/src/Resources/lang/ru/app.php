...
return [
    ...
    'layouts' => [
        ...
        'sliders'                  => 'Sliders',
        'taxes'                    => 'Налоги',
        'tax-categories'           => 'Категории налогообложения',
    ...
    'dashboard' => [
        ...
        'total-sale'                => 'Общее количество продаж',
        'average-sale'              => 'Среднее по продажам (Average Order Sale)',
        'total-unpaid-invoices'     => 'Общее количество неоплаченных счетов',
        'increased'                 => ':progress%',
        'decreased'                 => ':progress%',
        'sales'                     => 'Продажи',
        'top-performing-categories' => 'Лучшие категории по эффективности',
        'product-count'             => ':count Товаров',
        'top-selling-products'      => 'Наиболее продаваемые товары',
        'sale-count'                => ':count Продаж (Sales)',
    ...
    'account' => [
        ...
        'upload-image-info'    => 'Загрузите изображение профиля (100 x 100 пикселей) в формате PNG или JPG.',
        'remove-image'         => 'Удалить изображение',
        'image-upload-message' => 'Допускаются только изображения (.jpeg, .jpg, .png, ..).',
        'name'                 => 'ФИО',
        'email'                => 'Email',
        'password'             => 'Пароль',
